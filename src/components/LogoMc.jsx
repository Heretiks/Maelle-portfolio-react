...
const LogoMc = () => {
    ...
    let isContact = location.pathname === '/contact';
    ...
    return (
        <motion.svg
            ...
            width="75.897"
            height="63.507"
            viewBox="0 0 75.897 63.507"
            onHoverStart={() => setIsHovered(true)}
            onHoverEnd={() => setIsHovered(false)}
            style={{ cursor: 'pointer' }}
            className={`${isContact ? ' logo-img' : 'logo-image'}`}
        >
            <g id="Groupe_1">
                <motion.path
                    id="Tracé_1"
                    d="M0,.968H4.955l.88,4.874h.48A10.206,10.206,0,0,1,15.9,0Q22.7,0,24.856,6.077A11.13,11.13,0,0,1,29.21,1.56,11.756,11.756,0,0,1,35.084,0Q44.992,0,45,12.7L45,42.993l-6.553,0-.008-29.809q0-4.076-1.44-5.714a5.042,5.042,0,0,0-4-1.637q-3.038,0-5.113,3.118a14.926,14.926,0,0,0-2.076,8.392L25.824,43H19.271L19.263,13.19q0-4.076-1.44-5.714a5.043,5.043,0,0,0-4-1.637q-3.038,0-5.154,3.118a14.71,14.71,0,0,0-2.115,8.392L6.564,43,.01,43Z"
                ...
                <motion.path
                    ...
                    transform="translate(-54.096 -21.686)"
                    variants={letterVariants}
                    initial="initial"
                    animate={isHovered ? "animate" : "initial"}
                />
